...
![蝶野雏蓝白小宇宙主题背景](themes/hina-chono/background.png)

当前主题从蝶野雏条纹上衣提取水手蓝、浅薰衣草蓝与冰白作为界面配色；原粉色背景仍保留在 `themes/hina-chono/background-pink.jpg`，方便二次制作或手动切换。

## 实机效果

下图来自真实 Codex Desktop 会话，展示了主题布局、右侧面板适配和 Hina 宠物同时启用时的效果。截图使用保留的粉色背景版本，当前蓝白版沿用相同布局：
...
| 类型 | ID | 显示名称 | 路径 |
| --- | --- | --- | --- |
| Theme | `hina-chono` | 蝶野雏 · 蓝白小宇宙 | `themes/hina-chono/` |
| Pet | `hina` | Hina | `pets/hina/` |

主题包内含：

- `theme.json`
- `background.png`（1672 × 941，当前蓝白版）
- `background-pink.jpg`（3200 × 1801，保留的粉色版）
